# Roadmap - Venda de Móveis (Galeria)

## Visão Geral

Criação de uma landing page moderna e responsiva para atuar como catálogo/galeria de móveis à venda. O foco é em uma experiência visual impactante ("WOW factor"), simplicidade de manutenção e código limpo.
...
- [x] Status de Produto (Reservado/Vendido) e Badges Visuais
- [ ] SEO básico
- [/] Documentação final
